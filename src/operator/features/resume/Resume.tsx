...
const Resume = () => {
    ...
    const [readingMatrix, setReadingMatrix] = useState<ReadingMatrixDto | null>(null);
    ...
    const fetchResume = async () => {
        ...
        try {
            ...
            console.error(error);
            toast.error("Error al obtener los datos principales");
        } finally {
            setLoading(false);
        }
    };
    ...
    const fetchPeriods = async () => {
        try {
            ...
            console.error(error);
            toast.error("Error al obtener los períodos");
        }
    };
    ...
    const fetchBillChart = async (idPeriod: number) => {
        ...
        try {
            ...
            console.error(error);
            toast.error("Error al obtener gráfico de facturas");
        } finally {
    ...
    const effectiveTotalReadings = isViewingActivePeriod ? totalReadings : emittedBills > 0 ? emittedBills : totalReadings;
    ...
    const ctaKey: CtaKey = effectiveDoneReadings === 0 ? "start" : effectiveDoneReadings < effectiveTotalReadings ? "continue" : !hasInvoiceData ? "emit" : "view";
    ...
    const debtorsTotalAmount = debtors.reduce((total, debtor) => total + (debtor.debts?.reduce((sum, item) => sum + item.amount, 0) ?? 0), 0);
                            ...
                            <div className="rr-pipeline-steps">
                                <div className={`rr-pipeline-step ${stepStateClass(1)}`}>
                                    <div className="rr-pipeline-step-head">
                                        <div className="rr-pipeline-step-circle">{pipelineStep > 1 ? <i className="bi bi-check-lg"></i> : "1"}</div>
                                    ...
                                    <div className="rr-pipeline-step-caption">
                                        {effectiveDoneReadings} de {effectiveTotalReadings} registradas
                                    </div>
                                </div>

                                <div className={`rr-pipeline-step ${stepStateClass(2)}`}>
                                    <div className="rr-pipeline-step-head">
                                        <div className="rr-pipeline-step-circle">{pipelineStep > 2 ? <i className="bi bi-check-lg"></i> : "2"}</div>
                        ...
                        <div className="rr-padron-row">
                            ...
                            <div className="rr-padron-card">
                                <div className="rr-padron-head">
                                    ...
                                    <Link to="/dashboard/operator/readings/control" aria-label="Ver lecturas sin medidor" className="rr-padron-icon-link">
                                        <i className="bi bi-arrow-up-right"></i>
                                    </Link>
                                </div>
                                <div className="rr-padron-figure">
                                    <div className="rr-padron-value">{readingMatrixLoaded ? missingMeters : "—"}</div>
                                    {missingMeters === 0 ? (
                            ...
                            <div className="rr-padron-card">
                                ...
                                <div className="rr-padron-figure">
                                    ...
                                    <div className="rr-padron-sub">
                                        deudores
                                        {totalUsers > 0 ? ` · ${debtorsPctOfPadron.toLocaleString("es-AR", { maximumFractionDigits: 1 })}% del padrón` : ""}
                                    </div>
                                </div>
                            ...
                            <div className="rr-card rr-billing-card">
                                ...
                                {loadingChart ? (
                                    ...
                                    <div className="rr-billing-body">
                                        ...
                                        <div className="rr-billing-main rr-billing-wide">
                                            <div className="rr-donut-row">
                                                <div className="rr-donut rr-donut-lg">
                                                    <RoundedDonutChart data={invoicesData} size={150} innerRadius={47} outerRadius={72} cornerRadius={7} />
                                        ...
                                        <div className="rr-billing-narrow">
                                            <div className="rr-donut rr-donut-sm">
                                                <RoundedDonutChart data={invoicesData} size={96} innerRadius={32} outerRadius={48} cornerRadius={5} />
                                    ...
                                    <div className="rr-empty-billing">
                                        ...
                                        <div className="rr-empty-body">Las estadísticas de cobranza aparecen al emitir el primer lote del período.</div>
                                        <div
