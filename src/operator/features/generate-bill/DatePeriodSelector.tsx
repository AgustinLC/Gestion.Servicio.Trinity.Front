...
// react-datepicker refoca el input a mano después de limpiarlo con la "x"
// (sendFocusBackToInput), pero ese refoco puntual pisa su propio estado
// interno para no reabrir el calendario y, de paso, se salta el onFocus que
// le pasan por props. FloatingFieldset necesita ese onFocus para saber
// cuándo levantar el label; sin este listener nativo, el label queda tapado
// por el valor si se vuelve a escribir después de limpiar.
interface RobustFocusDatePickerProps {
  selected: Date | null;
...
const RobustFocusDatePicker: React.FC<RobustFocusDatePickerProps> = ({ onFocus, selected, ...props }) => {
